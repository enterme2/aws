...
<?php
include("connect.php");
$result=mysql_query("SELECT * FROM sedafiatform");
while($test = mysql_fetch_array($result))
	...
	echo "<tr><th><b>A. <u>Work Request</b></u></th></tr>";
	echo "<tr><th></th></tr>";
	echo "<tr>";
	echo "<th>Requested by :</th><th>".$test['requestedBy']."</th>";
	echo "<th>Job Title :</th><th>".$test['jobTitle']." </th>";
	echo "<th>Ref :</th><th>".$test['Ref']."</th>";
	echo "</tr>";
	/*
	<tr>
