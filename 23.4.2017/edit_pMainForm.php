...
<tr>
	<th align="right">Previous Work Date:</th><th><input type="text" name="pWorkDate" value='<?php echo $v25 ?>'></th>
	<th align="right">Previous Repair Date:</th><th><input type="text" name="pRepairDate" value='<?php echo $v26 ?>'></th>
</tr>
<tr>
	<th>Task No</th>
	<th>Description</th>
...
<tr>
	...
	<th><input type="text" name="targetDate" value='<?php echo $v29 ?>'></th>
...
<tr>
	<th align="right">Contract/Warranty Start Date:</th><th><input type="text" name="cwStartDate" value='<?php echo $v35 ?>'></th>
	<th align="right">End Date:</th><th><input type="text" name="cwEndDate" value='<?php echo $v36 ?>'></th>
</tr>
<tr>
...
<tr>
	...
	<th><input type="text" name="dateEmDetails1" value='<?php echo $v50 ?>'></th>
	<th><input type="text" name="startTime1" value='<?php echo $v51 ?>'></th>
	<th><input type="text" name="endTime1" value='<?php echo $v52 ?>'></th>
...
<tr>
	...
	<th><input type="text" name="dateEmDetails2" value='<?php echo $v57 ?>'></th>
	<th><input type="text" name="startTime2" value='<?php echo $v58 ?>'></th>
	<th><input type="text" name="endTime2" value='<?php echo $v59 ?>'></th>
...
<tr>
	...
	<th><input type="text" name="dateEmDetails3" value='<?php echo $v64 ?>'></th>
	<th><input type="text" name="startTime3" value='<?php echo $v65 ?>'></th>
	<th><input type="text" name="endTime3" value='<?php echo $v66 ?>'></th>
...
<tr>
	<th align="right">PPM Agreed Date:</th><th><input type="text" name="ppmAgreedDate" value='<?php echo $v70 ?>'></th>
</tr>
<tr>
	<th align="right">Date/Time Work Started:</th><th><input type="text" name="dateTimeStarted" value='<?php echo $v71 ?>'></th>
	<th align="right">Date/Time Work Completed:</th><th><input type="text" name="dateTimeCompleted" value='<?php echo $v72 ?>'></th>
...
<tr>
	...
	<th align="right">Date:</th><th><input type="text" name="dateCompleted" value='<?php echo $v76 ?>'></th>
	<th align="right">Verified by:</th><th><input type="text" name="verifiedBy" value='<?php echo $v77 ?>'></th>
	<th align="right">Date:</th><th><input type="text" name="dateVerified" value='<?php echo $v78 ?>'></th>
</tr>
<tr>
	<th></th><th></th>
	<th align="right">Time:</th><th><input type="text" name="timeCompleted" value='<?php echo $v79 ?>'></th>
	<th></th><th></th>
	<th align="right">Time:</th><th><input type="text" name="timeVerified" value='<?php echo $v80 ?>'></th>
</tr>
